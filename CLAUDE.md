...
1. **State Management**: The entity world is the state; the DOM reads it through `projectGameState` and re-renders on a signal (`src/shell/ShellStore.ts`), never on a tick
