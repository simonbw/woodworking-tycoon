...
/**
 * The audio controls (master / SFX / music volume + mute), backed by the
 * persisted store in `utils/audioSettings`. A section rather than a screen
 * of its own: settings live inside the pause menu, which is the only place
 * the game stops.
 */
