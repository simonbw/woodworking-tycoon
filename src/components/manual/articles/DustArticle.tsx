...
export const DustArticle: React.FC = () => (
  <>
    <P>
      ...
      penalties start once it piles up.
    </P>

    <H>The Broom</H>
    <P>
      Pick the broom up with <ShortcutKeys shortcut="pick-up" /> standing beside
      it. With it in hand, hold <ShortcutKeys shortcut="operate-machine" /> and
      walk: the broom sweeps the dust ahead of you into its <Term>dustpan</Term>
      . The mouse steers the head, so you can work a patch to either side
      without turning. Sweeping beside a machine also pulls dust out from under
      it, slowly.
    </P>
    <P>
