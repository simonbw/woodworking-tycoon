...
export const LumberArticle: React.FC = () => (
  <>
    ...
    <P>
      The small line under a board's name is its condition: the surface quality,
      and how far along the milling is. Milling & Surfaces covers what those
      marks mean and how to change them.
    </P>
