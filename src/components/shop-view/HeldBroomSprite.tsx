...
/**
 * What color the bristles are kicking right now: the dominant species on
 * the faced cell's floor, or in the pile being pushed. Null when there's
 * nothing there to kick — a dry stroke throws no chips.
 */
function sweptChipColor(gs: ReturnType<typeof useGameState>): string | null {
