...
export const jointer: MachineType = {
  ...
  collisionShapes: GENERATED_COLLISION_SHAPES.jointer,
  ...
  materialStorage: 0,
  toolSlots: 1,
  // One board on the beds at a time. There is no face/edge mode — how the
  // stock arrives decides (a rough board can only take a face pass; a
