 ...
 * actions that would move its settings, plan, tools, or upgrades all refuse.
 * These drive that through `ShopDriver`, so they go through the same actions
 * the keys and the station sheet do.
 */
