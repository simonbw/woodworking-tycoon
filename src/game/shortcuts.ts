...
const defs = [
  ...
  {
    // The bench rail's hooks answer to the numbers they wear: digit N
    // does what clicking the Nth hook does — take that tool in hand or
    // hang it back up, or hang a carried tool shown ghosted there.
    // Contextual like the door's rows, and on the same digits: the card
    // only opens at the cab and the rail only hangs in an open bench
    // view, so the two can never both be listening.
    id: "bench-tool-1",
    codes: ["Digit1"],
    keys: [["1"]],
    description: "Bench rail — first hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
  },
  {
    ...
    codes: ["Digit2"],
    keys: [["2"]],
    description: "Bench rail — second hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
  },
  {
    ...
    codes: ["Digit3"],
    keys: [["3"]],
    description: "Bench rail — third hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
  },
  {
    ...
    codes: ["Digit4"],
    keys: [["4"]],
    description: "Bench rail — fourth hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
  },
  {
    ...
    codes: ["Digit5"],
    keys: [["5"]],
    description: "Bench rail — fifth hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
  },
  {
    ...
    codes: ["Digit6"],
    keys: [["6"]],
    description: "Bench rail — sixth hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
  },
  {
    ...
    codes: ["Digit7"],
    keys: [["7"]],
    description: "Bench rail — seventh hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
  },
  {
    ...
    codes: ["Digit8"],
    keys: [["8"]],
    description: "Bench rail — eighth hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
  },
  {
    ...
    codes: ["Digit9"],
    keys: [["9"]],
    description: "Bench rail — ninth hook",
    scope: "home",
    group: "Machines",
    hidden: true,
    sharesKey: true,
