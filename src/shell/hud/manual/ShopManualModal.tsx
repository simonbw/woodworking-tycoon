...
import { ARTICLE_BODIES } from "../../../components/manual/articles";
...
export const ShopManualModal: React.FC<{
  ...
  // The manual's own key (?) also closes it; Escape comes with the shell.
  ...
  return (
    <Modal
      ...
      panelClassName="relative h-[85vh] w-full max-w-2xl -translate-x-10"
    >
