 ...
 * ingredients.
 *
 * Ported with the station sheets (the old file over the shell hooks);
 * its consumer — the bench view's plan browser — is phase 7 of the
 * migration, which mounts this as-is.
 */
