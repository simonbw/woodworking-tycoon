...
import {
  ...
  HandRule,
  HandStrike,
} from "../../../components/hand-drawn/HandDrawn";
import {
  HintSurfaceContext,
  ShortcutKeys,
...
import { dismissTutorial } from "../../../sim/commands/progression-commands";
 ...
 * sentences follow.
 *
 * The old `components/tutorial/TutorialCard.tsx` over the shell hooks:
 * the state comes from `useShopState()` and the skip goes through the
 * `dismissTutorial` command instead of the action setter.
 */
...
const TutorialCard: React.FC<{ view: TutorialGoalView }> = ({ view }) => {
  ...
  return (
    <HintSurfaceContext.Provider value="hand">
      <section
        className="paper-note pencil-hand pointer-events-auto relative space-y-2"
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            onClick={() => dismissTutorial(game, view.trackId)}
