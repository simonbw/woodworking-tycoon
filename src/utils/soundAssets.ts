 ...
 * and decoding those would be memory spent on
 ...
 *   pure-synth voices replaced them (machineSynth.ts); these stay as
 ...
 * - Long beds generated ahead of the systems that would play them.
 *
...
export const SOUND_FILES_NOT_PRELOADED: readonly string[] = [
  ...
  // streaming <audio> path, not the decode cache in `sfx.ts`.
