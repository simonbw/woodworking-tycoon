...
/**
 * A finished cutting board: rounded corners and a hanging hole. The old
 * CuttingBoardSprite's draw callback as a plain function.
 */
export function drawCuttingBoard(g: Graphics, material: FinishedProduct): void {
